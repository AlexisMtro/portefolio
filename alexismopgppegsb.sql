...
--
-- Hôte : alexismopgppegsb.mysql.db
-- Généré le :  sam. 08 déc. 2018 à 01:00
...
--
-- Base de données :  `alexismopgppegsb`
--
...
('', '201806', 0, NULL, '2018-06-12', 'CR', NULL),
('', '201807', 0, NULL, '2018-07-12', 'CR', NULL),
('', '201808', 0, NULL, '2018-08-12', 'CR', NULL),
('', '201809', 0, NULL, '2018-09-14', 'CR', NULL),
('', '201810', 0, NULL, '2018-10-29', 'CR', NULL),
...
(38, 'a17', '201806', 'test', '2018-06-02', '45.00', 0),
(39, 'a17', '201806', 'aa', '2018-02-03', '20.00', 0);
...
(878, 1, 36, NULL, '8 June, 2018', 'ok', 'ok', 4, '3MYC7', 2);
...
(1009, '1', 35, NULL, '8 June, 2018', 'ok', 'ok', 4, '3MYC7', 2);
...
ALTER TABLE `rapport_visite`
  ...
  ADD KEY `med_depotlegal` (`med_depotlegal`(255)),
  ADD KEY `pra_coefnotoriete` (`pra_coefnotoriete`),
...
--
ALTER TABLE `practicien`
  MODIFY `pra_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
--
-- AUTO_INCREMENT pour la table `rapport_visite`
--
ALTER TABLE `rapport_visite`
  MODIFY `rap_num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=879;
--
-- AUTO_INCREMENT pour la table `rapport_visite_del`
--
ALTER TABLE `rapport_visite_del`
  MODIFY `rap_num_del` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1010;
--
