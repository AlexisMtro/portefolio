...
// Récupérer toutes les données de la table type_praticien
    ...
    $sql2 = 'SELECT * FROM rapport_visite LEFT JOIN remplacant ON remplacant.rp_num = rapport_visite.rp_num';
